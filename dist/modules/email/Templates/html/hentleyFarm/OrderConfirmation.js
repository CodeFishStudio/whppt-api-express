...
const buildOrderForDisplay_1 = require("../../../helpers/buildOrderForDisplay");
const orderConfirmation = (order, domainId) => {
    var _a, _b;
    const invoiceUrl = `https://www.hentleyfarm.com.au/api/pdf/orderReceipt?orderId=${order._id}&domainId=${domainId || 'vl8z483o6'}`;
    return `
             ...
             <tr>
               <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                   <tbody>
                     ...
                     <tr>
                       <td align="center" valign="top" style="color:#ffffff;font-weight:500;font-size:24px;line-height: 28px; font-family:'Roxborough', Arial,sans-serif;padding-bottom:15px;"> Order #${order.orderNumber || order._id},</td>
                     </tr>
                     <tr>
                       <td align="center" valign="top" class="em_pbottom" style="color:#acacac;font-size:16px;line-height: 20px;padding-bottom: 30px; font-family:'Roxborough', Arial,sans-serif;">${((_a = order === null || order === void 0 ? void 0 : order.payment) === null || _a === void 0 ? void 0 : _a.date) &&
        new Date((_b = order === null || order === void 0 ? void 0 : order.payment) === null || _b === void 0 ? void 0 : _b.date).toLocaleDateString('en-US', {
            weekday: 'long',
            day: 'numeric',
            month: 'long',
            year: 'numeric',
...
const orderSummary = (order) => {
    ...
    ${lineItem(`Order discount`, totalDiscountedFromTotal, !!totalDiscountedFromTotal, '- $')}
    ${lineItem(`Subtotal`, subtotal, true, '$')}
    ${lineItem(`Member discount`, membersDiscount, !!membersDiscount, '- $')}
    ${lineItem(`Shipping`, shipping, true, shipping === 'Complimentary' || shipping === 'Pickup' ? '' : '$')}
    ${lineItem(`Total - (Tax incl. $${tax})`, total, true, '$')}
    `;
};
const lineItem = (header, value, show = true, prefix) => {
    if (!show)
        return '';
    return `
                  <tr>
...
const orderItem = (item) => {
    var _a, _b, _c;
    const _productName = (item === null || item === void 0 ? void 0 : item.productName) || ((_a = item === null || item === void 0 ? void 0 : item.product) === null || _a === void 0 ? void 0 : _a.name) || 'Legacy Item';
    const _vintage = ((_b = item === null || item === void 0 ? void 0 : item.product) === null || _b === void 0 ? void 0 : _b.customFields.vintage) || '';
    const _quantity = item.quantity.toString();
    const _purchasedPrice = ((item.purchasedPrice || ((_c = item === null || item === void 0 ? void 0 : item.product) === null || _c === void 0 ? void 0 : _c.price)) / 100)
        .toFixed(2)
        .toString();
    return `
   <tr>
