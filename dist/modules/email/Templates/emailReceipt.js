...
const Layout_1 = require("./html/hentleyFarm/Layout");
const OrderConfirmation_1 = require("./html/hentleyFarm/OrderConfirmation");
function getOrderTemplate(order, domainId) {
    return (0, Layout_1.hentleyFarmLayout)((0, OrderConfirmation_1.orderConfirmation)(order, domainId));
}
...
// }
//# sourceMappingURL=emailReceipt.js.map