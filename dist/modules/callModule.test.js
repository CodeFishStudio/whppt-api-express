...
test('callModule_fromDefaultExport', () => {
    ...
    return callModule(context, 'test', 'get', params, req).then(response => {
        ...
        expect(response).toBe('testing');
        expect(JSON.stringify(arg_exec_context)).toBe(JSON.stringify(Object.assign(Object.assign({}, context), { createEvent: () => sinon.fake() })));
        expect(arg_exec_params).toBe(params);
    });
});
//# sourceMappingURL=callModule.test.js.map