...
module.exports = function imagesExtractor(pageType, page) {
    let images = pageType && pageType.extractImages
    ...
    forEach(contentSections, contentSection => {
        forEach(page[contentSection], componentData => {
            ...
            const componentImages = compact(componentType && componentType.extractImages
...
//# sourceMappingURL=imagesExtractor.js.map